<template>
  <div class="root">
    ...
    <div class="container rel" style="--max-width: 632px">
      ...
      <div class="announce-winner" v-else>
    ...
    <CFModal :isOpen="isMenuOpen" :overlay="true" @close="isMenuOpen = false" h="49rem">
      <div class="menu">
        ...
        <div class="actions">
          ...
          <ButtonComponent label="Restart"></ButtonComponent>
...
export default {
  name: "GameView",
  components: {ButtonComponent, CFModal},
  setup() {
    ...
    const playerColor = computed(() => {
      return activePlayer.value === 1 ? 'red' : 'yellow'
    })
    ...
    const {putHere, winner} = useMoveCoinThrough({activePlayer, board, active, moving, radIndex})
