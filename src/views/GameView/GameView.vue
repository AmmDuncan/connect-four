      ...
      <div class="container rel" style="--max-width: 632px">
        ...
        <div :class="['board', 'hard-shadow']" :key="renderKey">
          <template v-for="(row, row_index) in board" :key="row_index">
            ...
            >
              <div
                  :class="['coin', { red: col === 1, yellow: col === 2 }]"
              ></div>
            </div>
          </template>
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                      ...
                      result="effect1_dropShadow_0_4141"
                  />
                  <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_0_4141"
                      result="shape"
                  />
                </filter>
              </defs>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_0_3849"
                />
                <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_0_3849"
                    result="shape"
                />
              </filter>
            </defs>
